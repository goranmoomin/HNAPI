...
final class ActionTests: XCTestCase {
    func testInverseActions() {
        ...
        XCTAssert(
            favoriteAction.inverseSet.contains(where: {
        ...
        XCTAssert(
            upvoteAction.inverseSet.contains(where: {
                $0.url.absoluteString
                    == "vote?id=22859090&auth=aae9081569d59f6cb252bc130f7987f80e4774f0&how=un"
            }))
        let unvoteAction = Action.unvote(
            URL(string: "vote?id=22859090&auth=aae9081569d59f6cb252bc130f7987f80e4774f0&how=un")!)
        XCTAssertEqual(unvoteAction.inverseSet.count, 2)
        XCTAssert(
            unvoteAction.inverseSet.contains(where: {
                $0.url.absoluteString
        ...
        XCTAssert(
            unvoteAction.inverseSet.contains(where: {
                $0.url.absoluteString
                    == "vote?id=22859090&auth=aae9081569d59f6cb252bc130f7987f80e4774f0&how=down"
            }))
    }
}
